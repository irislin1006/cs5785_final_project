...
print(predict_image_features.shape)
ranking(predict_image_features, train['image_2048'], train['image_id'], 'training_test_answer.csv')


print("=== test testing data ===")
predict_image_features = ridge.predict(test['captions'])
print(predict_image_features.shape)
